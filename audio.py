...
This code are adapted from the score-tube project:
...
def process_audio(input_path):
    ...
    audio_data = np.asarray(trimmed_audio.get_array_of_samples(), dtype=float)  # convert trimmed audio into numpy array
